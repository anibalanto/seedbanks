...
@Configuration
@EnableJpaRepositories("org.communityfarmer.seedbanks.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "org.communityfarmer.seedbanks.config.HerokuDatabaseConfiguration")
